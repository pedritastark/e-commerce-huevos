      ...
      <section className="py-24">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <h2 className="text-5xl lg:text-6xl font-bold text-red-600 mb-8 leading-tight">
                ¿Quieres saber de dónde viene nuestra frescura?
              </h2>

              <p className="text-2xl text-gray-800 leading-relaxed">
                Nuestra granja está en Sáname (Fosca, Cundinamarca), un pueblo rodeado de paisajes
                increíbles. Aquí nos aseguramos de que lo que recibes sea 100% natural, local y de la mejor calidad.
              </p>
            </motion.div>
            ...
            >
              <a
                href="https://www.google.com/search?client=safari&rls=en&q=4.336913518398727%2C+-73.91824315614546&ie=UTF-8&oe=UTF-8"
                target="_blank"
                rel="noopener noreferrer"
                className="bg-white p-4 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-300 cursor-pointer block"
              >
                <div className="aspect-square mb-4 flex items-center justify-center overflow-hidden">
                  <img
                    src="/granja-aerial.png"
                    alt="Vista aérea de Avícola Las Palmas"
                    className="w-full h-full object-cover"
                  />
                </div>
                <p className="text-2xl font-bold text-gray-900 text-center" style={{ fontFamily: 'cursive' }}>
                  Visita AVÍCOLA LAS PALMAS →
                </p>
              </a>
            </motion.div>
          </div>
      ...
      <section className="py-24 bg-[#E8E4D9]">
        <div className="max-w-7xl mx-auto px-6">
          <motion.h2
            ...
            viewport={{ once: true }}
            className="text-4xl lg:text-5xl font-bold text-amber-900 text-center mb-12"
          >
            Galería de la Granja
          </motion.h2>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            {[...Array(8)].map((_, i) => (
              <motion.div
                ...
                className="aspect-square bg-gradient-to-br from-amber-200 to-orange-200 rounded-lg overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer shadow-lg"
              >
