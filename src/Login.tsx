          ...
          <form onSubmit={handleLogin}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              ...
              >
                ...
                <input
                  ...
                  className="w-full px-4 py-3 border-2 border-red-600 rounded-full focus:outline-none focus:border-red-700 transition-colors text-sm"
                  placeholder=""
                  required
                />
              </motion.div>
            ...
            >
              <Link to="/register">
                <button
                  type="button"
                  className="w-full bg-white text-red-600 py-3 rounded-full font-bold text-sm border-2 border-red-600 hover:bg-red-50 transition-colors mb-3"
                >
